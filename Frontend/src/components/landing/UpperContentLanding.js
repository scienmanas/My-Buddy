                    ...
                    <Link to={`${authUser ? "/chat" : "/login"}`} className='w-fit h-fit'>
                        <button className="w-fit h-fit">
                            <div className="relative h-fit w-fit group">
                                <div className="absolute -inset-1 bg-gradient-to-r from-blue-300 to-pink-700 blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 rounded-2xl">
                                </div>
                                <div className="button-text cursor-pointer buttons-landing active:scale-95 transition-transform transform scale-100 hover:scale-105 relative px-7 py-3 sm:px-8 sm:py-4 md:py-5 md:px-9 lg:py-6 lg:px-10 font-bold border-gray-500 border-2 ring-1 ring-gray-900/5 rounded-3xl leading-none flex items-top justify-start space-x-6 bg-white">
