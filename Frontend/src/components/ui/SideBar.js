...
export default function SideBar(props) {
  return (
    <div
      className={`z-30 side-bar custom-height sm:min-h-screen items-center bg-[#1f2325] flex flex-col justify-between pt-3 sm:pt-4 pb-3 pl-1 pr-2 rounded-2xl ${
        props.isOpen ? "mx-2 absolute" : "-mx-60"
